...
budget_type = "Государственный бюджет в разрезе функциональной классификации"
...
if all_data:
    ...
    final_df.to_csv("Государственный бюджет в разрезе функциональной классификации.csv", index=False)
    print("\n[✔] Государственный бюджет в разрезе функциональной классификации.csv")
else:
    print("\n[!] Данных не найдено.")
