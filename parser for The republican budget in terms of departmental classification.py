...
budget_type = "Республикианский бюджет в разрезе ведомственной классификации"
...
if all_data:
    ...
    final_df.to_csv("Республиканский бюджет в разрезе ведомственной классификации.csv", index=False)
    print("\n[✔] Республиканский бюджет в разрезе ведомственной классификации.csv")
else:
    print("\n[!] Данных не найдено.")
