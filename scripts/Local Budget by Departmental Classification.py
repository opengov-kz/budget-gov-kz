...
budget_type = "Местный бюджет в разрезе ведомственной классификации"
...
if all_data:
    ...
    final_df.to_csv("Местный бюджет в разрезе ведомственной классификации.csv", index=False)
    print("\n[✔] Местный бюджет в разрезе ведомственной классификации.csv")
else:
    print("\n[!] Данных не найдено.")
