...
budget_type = "Республикианский бюджет в разрезе функциональной классификации"
...
if all_data:
    ...
    final_df.to_csv("Республиканский бюджет в разрезе функциональной классификации.csv", index=False)
    print("\n[✔] Все данные сохранены в Республиканский бюджет в разрезе функциональной классификации.csv")
else:
    print("\n[!] Данных не найдено.")
